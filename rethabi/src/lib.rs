...
pub use revm_primitives as ethereum_types;
pub use revm_primitives::{self, ruint};
...
/// ABI address.
pub type Address = revm_primitives::Address;
...
/// ABI signed integer.
pub type Int = revm_primitives::U256;

/// ABI unsigned integer.
pub type Uint = revm_primitives::U256;

/// Commonly used FixedBytes of size 32
pub type Hash = revm_primitives::B256;

/// Contract functions generated by rethabi-derive
